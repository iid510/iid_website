...
const japara: TownSeed = {
  slug: "japara",
  name: "Japara",
  eyebrow: "Ijebu-Igbo · Japara Quarter",
  tagline: "Named for the Jampara trees where Abijaparako first settled — home of the Lawusi, Owogbegi, Kileyo and Odokotolori families.",
  rulerTitle: "Ilufemiloye (Kotolori-Ojuule I) — The Abijaparako of Japara, Ijebu Igbo",
  rulerName: "His Royal Highness Oba Aderemi Adewale Ogunye (JP)",
  rulerPhoto: "/images/japara/oba-abijaparako-aderemi-adewale-ogunye.webp",
  quickFacts: [
    {
      icon: "MapPin",
      label: "Borders",
      value: "Oru, Ibadan, Oke-Sopen, Ojowo",
    },
    {
      icon: "Crown",
      label: "Ruler",
    ...
    },
    {
      icon: "Users",
      label: "Quarters",
      value: "Lawusi & Kileyo (20 Itun)",
    },
    {
      icon: "Target",
      label: "Families",
      value: "Lawusi, Owogbegi, Kileyo, Odokotolori",
    },
  ],
  history: [
  ...
  subdivisionGroups: [
    {
      groupLabel: "The 20 Ituns of Japara",
      items: [
        "Itun Lawusi I",
        "Itun Lawusi II",
        "Itun Owogbegi",
  ...
  chiefGroups: [
    {
      groupLabel: "Palace Chiefs",
      members: [
        {
          photo: "/images/japara/chief-ayodele-francis-ogunye-baba-oba-japara.webp",
          name: "Engr. Prof. Ayodele Francis Ogunye, D.Sc, FAEng",
          title: "Baba Oba of Japara",
        },
        {
          photo: "/images/japara/chief-babatunde-babatomiwa-rowaiye-mayegun-ijebu-igbo.webp",
    ...
    {
      groupLabel: "Current Chiefs of Japara",
      members: [
        {
          name: "Engr. Prof. Ayodele Francis Ogunye",
          title: "Baba Oba of Japara",
        },
        {
          name: "Chief Mrs. Bilola Solaja",
          title: "Yeye Oba of Japara",
        },
        {
          name: "Chief Engr. Bayo Dayo",
          title: "Akogun of Japara",
        },
        {
          name: "Chief Amos A. Ogunye",
          title: "Otunba Mejekobaje of Japara",
        },
        {
          name: "Otunba Dr. Babatunde Babatomiwa Rowaiye",
          title: "Otunba Odosigboro Japara & Mayegun of Ijebu-Igbo",
        },
        {
          name: "Otunba Adedotun Olukorede Fasanya",
          title: "Otunba Odokotolori",
        },
        {
          name: "Aare Olayinka Oni Olanrewaju",
          title: "Asiwaju of Japara",
        },
        {
          name: "Chief Ademola Adewunmi Dayo",
          title: "Otori Omoba Japara",
        },
      ],
    },
    {
      groupLabel: "Olori Ebi of Japara",
      members: [
        {
          name: "Chief Engr. Samuel Adebayo Dayo",
          title: "Olori Ebi Lawusi",
        },
        {
          name: "Chief Olusola Rowaiye",
          title: "Olori Ebi Owogbegi",
        },
        {
          name: "Chief Tokunbo Adeleke Talabi",
          title: "Olori Ebi Kileyo",
        },
        {
          name: "Otunba Adedotun Olukorede Fasanya",
          title: "Olori Ebi Odokotolori",
        },
      ],
    },
  ],
  baales: [
    {
      name: "Chief Adebanjo Adekoya Adepitan",
      title: "Baale Ganrigan",
    },
    {
      name: "Chief Keyinde Ogunfowoke",
      title: "Baale Awoyaya",
    },
    {
      name: "Chief Sunday Obisanya",
      title: "Baale Lorin",
    },
    {
      name: "Chief Olusayo Onabanjo",
      title: "Baale Ajebandele Ogunye",
    },
    {
      name: "Chief Onikolu Akanni",
      title: "Baale Ajebo Opebi",
    },
    {
      name: "Chief Shina Sabiu",
      title: "Baale Agbede",
    },
    {
      name: "Chief Adebayo Adelagun",
      title: "Baale Araromi Kukoyi",
    },
    {
      name: "Chief Tajudeen Nosiru",
      title: "Baale Ajepodomati",
    },
    {
      name: "Chief Taju Saibu",
      title: "Baale Eruobodo",
    },
    {
      name: "Chief John Adekoya",
      title: "Baale Poroporo",
    },
    {
      name: "Chief Keji Bilesanmi",
      title: "Baale Okoniyan Mosimi",
    },
    {
      name: "Chief Sali Musari",
      title: "Baale Agbalasan",
    },
    {
      name: "Chief Noshiru Buraimo",
      title: "Baale Ologun",
    },
    {
      name: "Chief Korede Badejo",
      title: "Baale Ologun Olabanjo",
    },
    {
      name: "Chief Alphonso Seidu",
      title: "Baale Abajeri",
    },
    {
      name: "Chief Sunday Ajayi",
      title: "Baale Isamo",
    },
    {
      name: "Chief Jacob Odushina",
      title: "Baale Iseru",
    },
    {
      name: "Chief Jokotola Talabi",
      title: "Baale Idioparun",
    },
    {
      name: "Chief Amusa Badewa",
      title: "Baale Araromi Badewa",
    },
    {
      name: "Chief Adekafaru",
      title: "Baale Oposiga",
    },
    {
      name: "Chief Badewa Sekoni",
      title: "Baale Abarika Sekoni",
    },
    {
      name: "Chief Wahab Hassan",
      title: "Baale Okoliwo",
    },
    {
      name: "Chief Tade Alase",
      title: "Baale Okoneku",
    },
    {
      name: "Chief Makonjuola Okeowo Ogunye",
      title: "Baale Eyinojugbo",
    },
    {
      name: "Loni",
    },
  ...
  pastRulers: [
    {
      ...
      title: "Chief",
      name: "Otesile",
      house: "Lawusi Family, Lawusi Quarters",
      years: "1909",
    },
    {
      order: 2,
      title: "Chief",
      name: "E. O. Oduyemi",
      house: "Kileyo Quarters — brought Christianity to Japara via St. Luke's (Ang) Church",
      years: "1929",
    },
    {
      order: 3,
    ...
    },
    {
      ...
      title: "Chief",
      name: "M. K. Odujobi",
      house: "Kileyo Quarters — crowned Oba on 15 February 1997 by the Awujale, His Royal Majesty Oba (Dr.) Sikiru Kayode Adetona (Ogbagba II)",
      years: "1983 – Aug. 2003",
    },
    {
      order: 5,
      title: "HRH Oba",
      name: "Aderemi Adewale Ogunye",
      house: "Ilufemiloye, Kotolori-Ojuule I — installed after the stool remained vacant from 2003; celebrating his 10th coronation anniversary",
      years: "Present",
      current: true,
    },
  ],
  ...
  galleryCaptions: [
    {
      ...
      caption: "Immediate Past Obas of Japara — Oba Moses Kolawole Odujobi, Chief Emmanuel Oduyemi (Baale of Japara), Chief Albert Onateluwo (Olori Ilu of Japara)",
    },
    {
      image: "/images/japara/japara-current-chiefs.webp",
      caption: "Current Chiefs of Japara",
    },
    {
      image: "/images/japara/japara-current-olori-ebis.webp",
      caption: "Current Olori Ebi of Japara",
    },
    {
      image: "/images/japara/japara-current-baales-oloriwuns.webp",
      caption: "Current Baales and Oloritun of Japara",
    },
    {
      image: "/images/japara/japara-current-pampa-osugbos.webp",
    ...
    {
      image: "/images/japara/japara-projects-achievements-2.webp",
      caption: "Japara community projects, page 2",
    },
    {
      image: "/images/japara/japara-projects-achievements-3.webp",
      caption: "Japara community projects, page 3",
    },
  ],
  sourceNote: "Source: Iwe Itan Ilu Japara (1960) by Chief Albert Adeyemi Onateluwo, Isaac Ayodele Asebowale, Isaiah Orekoya Onabaki & Adeeko Agun; Coronation Brochure of HRH Alayeluwa Oba Aderemi Adewale Ogunye (2006); Minutes of Abijaparako In-Council Meeting, 30/03/2024.",
};

export default japara;
